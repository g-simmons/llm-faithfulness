...
def test_save_and_load_string_notation(catalog_with_temp_dir):
    ...
    catalog.data_save({'train': sample_train_data_string, 'test': sample_test_data_string}, rule_names, notation_type='string_notation')
...
def test_save_and_load_set_notation(catalog_with_temp_dir):
    ...
    catalog.data_save({'train': sample_train_data_set, 'test': sample_test_data_set}, rule_names, notation_type='set_notation')
